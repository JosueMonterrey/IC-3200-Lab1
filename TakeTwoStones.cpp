...
There are N stones placed on the ground, forming a sequence.
...
Assume both Alice and Bob play optimally and Alice plays first, 
do you know who the winner is?


# Input
    The input contains an integer N (1 <= N <= 10^7), the number of stones.
